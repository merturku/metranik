...
export default function HavalandirmaDebiKontroluPage() {
  return (
    <CalcPage
      ...
      description="Saha ölçüm kontrolü: ölçülen debi, tasarımda hesaplanan gerekli debiyi karşılamalı (Völçülen ≥ Vgerekli). Gerekli debi Taze Hava Debisi gibi bir tasarım modülünden gelir."
      fields={[
